...
top.snps <- add.nearby.gene(top.snps, immune.genes, dist = 100000, gene_type='nearby_immune')
```
...
top.snps.kable <- top.snps[ , c('snp','gwas_catalog','inside_gene','nearby_driver','nearby_immune','breast_gtex_eGenes','whole_blood_gtex_eGenes','merged','consequence','zscore','susie_pip','locus','locuszoom')]
colnames(top.snps.kable) <- c('SNP','GWAS Catalog','Gene Inside','Nearby Drivers (100kb)','Nearby Immune Gene (100kb)','Breast eGenes','Whole-Blood eGenes','Annotation','Consequence','ZScore','PIP','Locus','locuszoom')
